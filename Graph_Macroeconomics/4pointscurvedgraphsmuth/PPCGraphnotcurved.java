...
public class PPCGraphnotcurved extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (int i = 1; i < food.length; i++) {
            ...
            ppcCurve.quadTo(ctrlX, ctrlY, 50 + videoGames[i] * 15, 250 - food[i] * 25);
        }
        g2d.draw(ppcCurve);
    ...
    public static void main(String[] args) {
        ...
        frame.add(new PPCGraphnotcurved());
